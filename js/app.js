...
function modalJoinSchoolWorkspace() {
  openModal("Add another staff workspace", `<form data-form="join-school-workspace"><div class="field"><label>Internal staff, teacher-department or co-teacher code</label><input name="inviteCode" placeholder="e.g. T7K4M2Q9" autocomplete="off" autocapitalize="characters" spellcheck="false" required><span class="field-help">Enter the 8-character staff code. Your existing workspaces and permissions remain available.</span></div><div class="form-actions"><button class="btn btn-primary">Add workspace</button></div></form>`);
}
