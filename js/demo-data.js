...
export const demoData = {
  ...
  feedbackSessions: [
    { id: "session-1", classId: "n5-computing-a", subjectId: "computing", pupilIds: ["demo-pupil", "pupil-1", "pupil-2", "pupil-3", "pupil-4"], title: "Programming prelim feedback", skill: "Programming", feedbackType: "Prelim", assessmentComponent: "Paper 1", instructions: "Use your marked paper. Record one precise mistake and what you will do differently.", date: daysAgo(0).slice(0, 10), status: "open", createdBy: "demo-teacher", createdAt: daysAgo(0) }
  ],
  improvementBank: [
    { id: "bank-f1", feedbackId: "f1", pupilId: "demo-pupil", classId: "n5-computing-a", subjectId: "computing", title: "Python Selection", topic: "Selection", mistake: "Explain why each condition is needed using the actual variables from the question.", mistakeHtml: "<p>Explain why each condition is needed using the <strong>actual variables</strong> from the question.</p>", improvementPlan: "Name the variables and link each condition to the scenario.", status: "Secure", confidence: "Green", pinned: false, evidence: "Corrected two selection explanations.", dateIdentified: daysAgo(60) },
    { id: "bank-f2", feedbackId: "f2", pupilId: "demo-pupil", classId: "n5-computing-a", subjectId: "computing", title: "Database Progress Check", topic: "SQL", mistake: "Practise ORDER BY with ASC and DESC, then explain what changes in the output.", mistakeHtml: "<p>Practise <strong>ORDER BY</strong> with ASC and DESC, then explain what changes in the output.</p>", improvementPlan: "Complete three sorting queries and explain the result order.", status: "Practising", confidence: "Amber", pinned: true, evidence: "", dateIdentified: daysAgo(34) }
  ],
  riskOverrides: [
    { id: "risk-review-1", pupilId: "pupil-2", classId: "", calculatedLevel: "Medium", selectedLevel: "Low", decision: "reduce", reason: "Recent absence explains two incomplete feedback actions. Review after catch-up week.", reviewDate: daysAgo(-7).slice(0, 10), active: true, createdBy: "demo-teacher", createdByName: "Mrs Miller", createdAt: daysAgo(1) }
  ],
  invites: [
